...
class PosOrderReportInherited(models.Model):
    _inherit = "report.pos.order"

    date = fields.Datetime(string='Order Date', readonly=True)
    order_id = fields.Many2one('pos.order', string='Order', readonly=True)
    partner_id = fields.Many2one('res.partner', string='Beneficiary', readonly=True)#
    ...
    product_categ_id = fields.Many2one('product.category', string='Medicine Category', readonly=True)#
    invoiced = fields.Boolean(readonly=True)
    config_id = fields.Many2one('pos.config', string='Dispensary', readonly=True)#
