...
var PosNameWidget = PosBaseWidget.extend({ // changed here for posname
    template: 'PosNameWidget',
    init: function(parent, options){
        options = options || {};
        this._super(parent,options);
    },
    ...
    //     });
    // },
    get_posname: function(){
        // var user = this.pos.get_cashier();
        var user = this.pos.pos_session.config_id;
        if(user){
            return user[1];
        }else{
            return "";
...
var dasbNameWidget = PosBaseWidget.extend({ 
    template: 'dasbNameWidget',
    init: function(parent, options){
        options = options || {};
        this._super(parent,options);
    },
    ...
    get_dasb: function(){
        var dasb = this.pos.config.dasb_id;
        if(dasb){
            return dasb[0];
        }else{
            return "";
    ...
    widgets: [
        {
            ...
            'name':   'posname', // changed here for posname
            'widget': PosNameWidget,
            'replace':  '.placeholder-PosNameWidget',
        },{
            'name':   'dasb', // changed here for dasb
            'widget': dasbNameWidget,
            'replace':  '.placeholder-dasbWidget',
        }
    ],
...
return {
    ...
    PosNameWidget: PosNameWidget, // changed here for posname
};
});
