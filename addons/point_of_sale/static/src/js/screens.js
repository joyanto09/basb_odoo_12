...
var ActionpadWidget = PosBaseWidget.extend({
    ...
    // Special edition mamun start
    validation_function: function(){
        return true;
    },
    // Special edition mamun end
    renderElement: function() {
        var self = this;
        this._super(); 
        ...
        this.$('.pay').click(function(){
            ...
            // Special edition mamun start
            var is_validation_ok = self.validation_function();
            // Special edition mamun end
            ...
            // Special edition mamun start
            else if(is_validation_ok){
            // uncomment else to recover previous app
            // Special edition mamun end
            // else{
                self.gui.show_screen('payment');
            }
...
// Actual Version of pervious Function
// var ActionpadWidget = PosBaseWidget.extend({
//     template: 'ActionpadWidget',
//     init: function(parent, options) {
//         var self = this;
...
var ReceiptScreenWidget = ScreenWidget.extend({
    ...
    get_receipt_render_env: function() {
        ...
        {   
            ...
            customer_sex = customer.gander_status;
        }
...
var PaymentScreenWidget = ScreenWidget.extend({
    ...
    order_is_valid: function(force_validation) {
        ...
        if (order.get_orderlines().length === 0) {
            // this.gui.show_popup('error',{
            //     'title': _t('This is custom popup'),
            //     'body':  _t('This is custom popup'),
            // });
            this.gui.show_popup('error',{
